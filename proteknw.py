...
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EGaMBmoPV7fOc2t20ig5.vFPON0VylrTkFiwoxq5mLq.ie17BiMV9vnXe1KvVfGug0+J0g/AAARYCpG0odhIQqc=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EGPjekZ8UfeS9zn64wZ2.rH7zuV73lmOXcqZTSAumuG.5CHiNc/Ei1XTpz9YLi6YKd846Grzcs5qwQI1Eo9KZm0=')
kk.loginResult()
...
#vipro.login(qr=True)
vipro.login(token='EGJnXtgzswu7Wulw92Rd.dRgjRJrrg3tWZAAxf+xglq.j2zm0fmzFWnQKAaxOFKc53ZErgnZBPUzERB01yPoTZU=')
vipro.loginResult()
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            if msg.contentType == 13:
                if wait['invite'] == True:
                     ...
                     for s in groups.members:
                         if _name in s.displayName:
                             random.choice(KAC).sendText(msg.to, _name + " Sudah ada disini tuan")
                         else:
		...
		try:
		    if msg.from_ in Creator:
			        ...
			        cl.sendText(msg.to,"Sudah join mas ke ["+ h +"] Group")
			    else:
			        pass
		    else:
		        cl.sendText(msg.to,"Khusus Ark")
		...
		if msg.from_ in Creator:
			    ...
			    kc.leaveGroup(i)
			    kr.leaveGroup(i)
			    cl.sendText(msg.to,"Sudah meninggalkan mas dari ["+ h +"] group")
			else:
			    pass
		else:
		    cl.sendText(msg.to,"Khusus Ark")
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Ark")
                ...
                if wait["Sambutan"] == True:
                    ...
                    wait["joinkick"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on mas")
                ...
                if msg.to in cctv['point']:
                    ...
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Nyimak mode off")
                else:
                    cl.sendText(msg.to, "Heh Belom di Set cuk :v")                         
